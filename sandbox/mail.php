...
try {
  ...
  $mail->isHTML(true);
  $mail->Subject = 'Son los enanos hobbits? el debate.';
  $mail->Body = 'Los hobbits son enanos mal interpretados? si lo pensamos bien a aprte de las extremidades peludas y las uñas desrolladas de sus pies, són en esencia iguales.';
  $mail->AltBody = 'Debate Serio';
  $mail->send();
