...
<form action="/student022/backend/customers/customers.php" method="post">
     <input type="number" id="id_customer" name="id_customer" value="<?php echo $id_customer; ?>" hidden="true">
     <input class="w-full h-full cursor-pointer" width="100%" type="submit" id="send" name="send" value="See ">
</form>