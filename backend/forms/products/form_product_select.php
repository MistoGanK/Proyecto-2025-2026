...
<form action="/student022/shop/backend/products/products.php" method="post">
        <input type="number" id="id_product" name="id_product" hidden="true" value="<?php echo $id_product; ?>">
        <input class="w-full h-full cursor-pointer" height="100%" width="100%" type="submit" id="send" value="See">
    </form>
