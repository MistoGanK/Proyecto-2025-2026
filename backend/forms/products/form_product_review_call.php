...
<form action="/student022/backend/forms/products/form_product_review.php" method="post">
  ...
  <input class="w-full h-full cursor-pointer" type='submit' value='Make a review'>
</form>