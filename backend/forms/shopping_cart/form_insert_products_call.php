...
<?php 
  ...
  if (isset($_SESSION['role']) && $_SESSION['role'] !== 'Guest') {
    echo '<form class="w-full h-full" action="/student022/backend/forms/db/shopping_cart/db_shopping_cart_checkout.php" method="post">';
    ...
    echo "<a class='w-full h-full cursor-pointer' href='/student022/backend/autentification/login.php'> Log in";
    echo '</a>';
